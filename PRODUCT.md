...
- Distribution: `install.sh` (defaults to latest stable; pre-release tags are GitHub prereleases), GitHub Releases, `go build`. Version lives in `internal/version/version.go` (currently `0.3.0-beta.3`).
